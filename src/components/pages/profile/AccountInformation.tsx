...
export default function AccountInfoMode<T = { [x: string]: string | object | number }>({
  fields,
}: {
  fields: T
}) {
 ...
 * @returns {boolean}
 */
const isValueObject = (param: object | string) => typeof param === 'object'
...
const formatValue = (param: any): string => {
  if (typeof param === 'string' && validator.isISO8601(param as string)) {
